...
app.config.update(dict(DATABASE ='./flaskr.db', DEBUG = True))
## configuration
...
def main_page():
	return render_template('mp_collection.html')
...
def insert_collection():
	if request.method == 'POST':
		...
		Bib_file.save(FILE_PATH)
		input_col_name = request.form['collection_name']
		# save the file
